...
void InitGUIColorDemo() {
    panels.colorDemo->AddChildren({
        ...
        (new Text)->SetPosition(0, 40)->SetText("RGB 255, 0, 255")->SetColor(std::make_shared<Color>()->SetRGB(255, 0, 255))->SetFontAlign(FontAlign::ascender),
        (new Text)->SetPosition(0, 80)->SetText("Hex #e38212")->SetColor(std::make_shared<Color>()->SetHex("#e38212"))->SetFontAlign(FontAlign::ascender),
