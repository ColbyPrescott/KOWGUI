...
void InitGUIGroupDemo() {
    panels.groupDemo->AddChildren({
        (new Draggable)->SetPosition(50, 50)->SetSize(100, 50)->AddChildren({
            ...
            (new Text)->SetPosition(0, 0)->SetWidth(400)->SetText("Drag me!\nBoth rectangles follow\nRed inherits size")->SetFont(Text::fontPixelated)->SetFontSize(13)->SetFontAlign(Text::FontAlign::ascender)->SetOverflow(Text::Overflow::wrap)
        }),
        (new Group)->SetPosition(250, 100)->SetSize(100, 50)->AddChildren({
            ...
            (new Text)->SetPosition(0, 0)->SetWidth(400)->SetText("Static group")->SetFont(Text::fontPixelated)->SetFontSize(13)->SetColor(Color::black)->SetFontAlign(Text::FontAlign::ascender)
        }),
    });
}