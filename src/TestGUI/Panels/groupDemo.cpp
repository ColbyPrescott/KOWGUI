...
void InitGUIGroupDemo() {
    panels.groupDemo->AddChildren({
        (new Draggable)->SetPosition(50, 50)->SetSize(100, 50)->AddChildren({
            ...
            (new Text)->SetPosition(0, 0)->SetWidth(400)->SetText("Drag me!\nBoth rectangles follow\nRed inherits size")->SetFont(Fonts::optimizedSmall)->SetFontSize(13)->SetVerticalAlign(VerticalAlign::ascender)->SetOverflow(Overflow::wrap)
        }),
        (new Group)->SetPosition(250, 100)->SetSize(100, 50)->AddChildren({
            ...
            (new Text)->SetPosition(0, 0)->SetWidth(400)->SetText("Static group")->SetFont(Fonts::optimizedSmall)->SetFontSize(13)->SetColor(Color::black)->SetVerticalAlign(VerticalAlign::ascender)
        }),
    });
}