...
void InitGUITextFontDemo() {
    panels.textFontDemo->AddChildren({
        ...
        (new Text)->SetPosition(10, 90)->SetText("Prop. Opt. Small 40")->SetFont(Fonts::optimizedSmall)->SetFontSize(40)->SetColor(Color::red)->SetFontAlign(FontAlign::ascender),
        ...
        (new Text)->SetPosition(10, 180)->SetText("Prop. Opt. Small 20")->SetFont(Fonts::optimizedSmall)->SetFontSize(20)->SetColor(Color::lime)->SetFontAlign(FontAlign::ascender),
        ...
        (new Text)->SetPosition(10, 230)->SetText("Prop. Opt. Small 10")->SetFont(Fonts::optimizedSmall)->SetFontSize(10)->SetColor(Color::blue)->SetFontAlign(FontAlign::ascender),
    });
}