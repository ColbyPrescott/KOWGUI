...
void InitGUIRowDemo() {
    panels.rowDemo->AddChildren({
        ...
        (new Clickable)->SetPosition(20, 30)->SetSize(30, 30)->SetRelease(AppendNodeToRows)->AddChildren({
            ...
            (new Text)->SetPosition(1, 2)->SetText("+")->SetFontSize(30)->SetHorizontalAlign(HorizontalAlign::center)->SetVerticalAlign(VerticalAlign::middle),
        }),
        ...
        (new Group)->SetY(20)->AddChildren({
            (new Row)->SetShallowID("scaleToFit")->SetPosition(30, 150)->SetWidth(200)->SetHeight(40)->SetScaleToFit(true)->SetSpacing(10)->AddChildren({
                (new Rectangle)->SetSize(40, 40)->SetFillColor(Color::red)->SetOutlineColor(Color::white)->AddChildren({
                    (new Text)->SetText("Scale")->SetFontSize(20)->SetHorizontalAlign(HorizontalAlign::center)->SetVerticalAlign(VerticalAlign::middle)->SetOverflow(Overflow::hidden),
                }),
                (new Rectangle)->SetSize(20, 40)->SetFillColor(Color::red)->SetOutlineColor(Color::white)->AddChildren({
                    (new Text)->SetText("To")->SetFontSize(20)->SetHorizontalAlign(HorizontalAlign::center)->SetVerticalAlign(VerticalAlign::middle)->SetOverflow(Overflow::hidden),
                }),
                (new Rectangle)->SetSize(80, 40)->SetFillColor(Color::red)->SetOutlineColor(Color::white)->AddChildren({
                    (new Text)->SetText("Fit")->SetFontSize(20)->SetHorizontalAlign(HorizontalAlign::center)->SetVerticalAlign(VerticalAlign::middle)->SetOverflow(Overflow::hidden),
                }),
                (new Rectangle)->SetSize(40, 40)->SetFillColor(Color::red)->SetOutlineColor(Color::white)->AddChildren({
                    (new Text)->SetText("Grab ->")->SetFontSize(20)->SetHorizontalAlign(HorizontalAlign::center)->SetVerticalAlign(VerticalAlign::middle)->SetOverflow(Overflow::wrapScale)->SetWrapLineSpacing(1),
                }),
            }),
