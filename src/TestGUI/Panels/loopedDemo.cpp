...
void InitGUILoopedDemo() {
    panels.loopedDemo->AddChildren({
        ...
        (new Toggleable)->SetPosition(20, 20)->SetSize(160, 200)->AddChildren({
            ...
            (new Text)->SetY(20)->SetText("Press (x)")->SetFontSize(20)->SetAlignments(HorizontalAlign::center, VerticalAlign::top, FontAlign::ascender)->SetPreTick(UpdateClicksText),
            ...
            (new Looped)->SetPosition(10 + (140 / 2) * 0, 50)->SetSize(140 / 2, 40)->SetLoopLength(2)->SetLoopTargets({0})->AddChildren({
                ...
                (new Text)->SetText("Len: 2\nTar: 0")->SetFontSize(12)->SetColor(Color::black)->SetAlignments(HorizontalAlign::center, VerticalAlign::middle, FontAlign::middle),
            }),
            (new Looped)->SetPosition(10 + (140 / 2) * 1, 50)->SetSize(140 / 2, 40)->SetLoopLength(2)->SetLoopTargets({1})->AddChildren({
                (new Rectangle)->SetFillColor(Color::lime),
                (new Text)->SetText("Len: 2\nTar: 1")->SetFontSize(12)->SetColor(Color::black)->SetAlignments(HorizontalAlign::center, VerticalAlign::middle, FontAlign::middle),
            }),
            ...
            (new Looped)->SetPosition(10 + (140 / 3) * 2, 100)->SetSize(140 / 3, 40)->SetLoopLength(3)->SetLoopTargets({2})->AddChildren({
                (new Rectangle)->SetFillColor(Color::lime),
                (new Text)->SetText("Len: 3\nTar: 2")->SetFontSize(12)->SetColor(Color::black)->SetAlignments(HorizontalAlign::center, VerticalAlign::middle, FontAlign::middle),
            }),
            ...
            (new Looped)->SetPosition(10, 150)->SetSize(140, 40)->SetLoopLength(5)->SetLoopTargets({0, 1, 3})->AddChildren({
                ...
                (new Text)->SetText("Length: 5\nTargets: 0, 1, 3")->SetFontSize(12)->SetColor(Color::white)->SetAlignments(HorizontalAlign::center, VerticalAlign::middle, FontAlign::middle),
            }),
