...
namespace KOWGUI {
    namespace Keyboard {
        ...
        Group* CreateNumpad(int x = 10, int y = 10, int width = 100, int height = 150, bool movable = true, bool resizable = true, Color* customWindowBarColor = nullptr, Color* customButtonNFocusedColor = nullptr, Color* customButtonFocusedColor = nullptr, Color* customHighlightColor = nullptr);
